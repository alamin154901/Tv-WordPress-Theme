...
function my_theme_register_required_plugins() {
	...
	$plugins = array(
		...
		array(
			'name'               => 'Video Sidebar Widgets', // The plugin name.
			'slug'               => 'video-sidebar-widgets', // The plugin slug (typically the folder name).
			'source'             => get_stylesheet_directory() . '/lib/tgm/plugins/video-sidebar-widgets.zip', // The plugin source.
